...
class GDScriptLexer(RegexLexer):
    ...
    tokens = {
        ...
        "builtin": [
            ...
            # NOTE: from github.com/godotengine/godot-docs
            (
                r'@(?:abstract|export(?:_(?:category|color_no_alpha|custom|dir|enum|exp_easing|file|file_path|flags(?:_2d_navigation|_2d_physics|_2d_render|_3d_navigation|_3d_physics|_3d_render|_avoidance)?|global_dir|global_file|group|multiline|node_path|placeholder|range|storage|subgroup|tool_button)?)?|icon|onready|rpc|static_unload|tool|warning_ignore(?:_restore|_start)?)'
                r'(?:\([^)]*\))?',
                Name.Decorator,
            ),
        ],
